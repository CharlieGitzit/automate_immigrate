...
This is a personal project to explore what life is like "without VScode"

Observation: 
    cursor pointer while entering VScode wasn't scaling correctly making it difficult to navigate work environment

Action:
     uninstalled VScode and config files

Take-Aways: 
    my environment and use cases are capable with Vim & CLI
